...
export const destinationData = [
    {
        title: 'VAAVU SHIPWRECK',
        longDescription: `The shipwreck known as 'Aslu Break' near Keyodhoo Island in Vaavu Atoll, Maldives, is a captivating and picturesque site that has gained popularity as one of the most Instagram-worthy spots in the region. Nestled in the crystal-clear waters, this shipwreck offers a stunning backdrop for underwater exploration and photography ${'\n'} ${'\n'}As you snorkel around the Aslu Break, you'll be greeted by a vibrant and diverse marine ecosystem. The wreck acts as an artificial reef, attracting an abundance of marine life. Schools of colorful tropical fish gracefully swim among the rusted remains, creating a mesmerizing spectacle. The clear waters allow for excellent visibility, ensuring you won't miss any of the underwater wonders. ${'\n'} ${'\n'}Whether you're an avid snorkeler or a beginner, the shipwreck provides a unique and unforgettable experience. As you glide through the water, you'll have the opportunity to observe various species of fish, including vibrant coral fish, playful clownfish, and majestic parrotfish. The wreck's structure also offers hiding places for smaller marine creatures like crustaceans and nudibranchs, adding to the overall charm and diversity of the site. ${'\n'} ${'\n'}Beyond its aesthetic appeal, the shipwreck holds historical significance, as it serves as a reminder of maritime events and stories from the past. Exploring the wreck allows you to connect with the rich maritime heritage of the Maldives.${'\n'} ${'\n'}For those seeking an extraordinary adventure and a chance to capture stunning underwater photographs, the Aslu Break shipwreck is a must-visit destination in Vaavu Atoll. With its vibrant marine life, captivating surroundings, and the allure of exploring an underwater relic, this enchanting spot promises a memorable and awe-inspiring experience for snorkelers and photography enthusiasts alike.`,
        image: require('../../assets/images/Shipwreck.jpg')
    },
    {
        title: 'SNORKELLIN',
        longDescription: "Snorkeling and diving are among the top things to do in the Maldives. Keyodhoo has a beautiful house reef, you'll be able to go directly from the beach. If you're traveling on a budget, staying at a guesthouse in Keyodhoo you'll still be able to enjoy the marine life in the Maldives",
        image: require('../../assets/images/Snorkeling.jpg')
    },
    
    {
        title: 'SCUBA DIVING',
        longDescription: "Scuba diving in the Maldives is a breathtaking experience, with clear waters and diverse marine life. With over 1,000 coral islands, it offers dive sites suitable for all levels. Manta Point, Banana Reef, and HP Reef are among the best sites. It's a must-do for diving enthusiasts.",
        image: require('../../assets/images/diving2.jpg')
    },
    {
        title: 'SANDBANK PICNIC',
        longDescription: "A sandbank picnic in the Maldives is a unique experience to enjoy the turquoise waters and white sandy beaches. Guests can swim, snorkel, sunbathe, and play beach games. All the guesthouses offer this activity with lunch served on the sandbank.",
        image: require('../../assets/images/sandbank2.jpg')
    },
    {
        title: 'SPORTS FISHING',
        longDescription: "Sports fishing is a popular activity in Keyodhoo Island. Keyodhoo offers world-class fishing opportunities, with an abundance of fish species such as tuna, marlin, sailfish, barracuda, and wahoo. Tourists can enjoy both day and night fishing, with the option of traditional hand-line fishing or modern techniques like jigging and trolling. Keyodhoo island offers sports fishing trips, with experienced guides and top-of-the-line equipment.",
        image: require('../../assets/images/fish2.jpg')
    },
    {
        title: 'ISLAND PICNIC',
        longDescription: "Uninhabited islands in the Maldives offer a serene and peaceful experience for travelers looking to escape the hustle and bustle of everyday life. With pristine white sand beaches, crystal-clear waters, and an abundance of marine life, these islands are perfect for snorkeling, diving, and other water sports. Many of these islands also offer opportunities for sunbathing and nature walks.",
